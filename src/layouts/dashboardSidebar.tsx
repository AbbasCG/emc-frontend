  ...
  return [
    ...
    // ── Group 4: العمليات والطلبات ────────────────────────────────────────
    {
      ...
      items: [
        ...
        { label: 'لوحة التشغيل',            href: '/dashboard/operations/board',              icon: ClipboardList  },
        { label: 'تقارير الاجتماعات',       href: '/dashboard/operations/meeting-reports',    icon: Presentation   },
        { label: 'التقارير الأسبوعية',      href: '/dashboard/operations/weekly-reports',     icon: CalendarDays   },
        { label: 'نقاط الأثر',              href: '/dashboard/operations/impact-points',      icon: Star           },
  ...
  if (n === 'partnerships_manager') {
    return [
      { items: [{ label: 'لوحة الشراكات والعلاقات', href: '/dashboard/partnerships-manager', icon: HeartHandshake }] },
      {
        ...
        items: [
          { label: 'سجل الشركاء', href: '/dashboard/admin/partners', icon: HeartHandshake },
