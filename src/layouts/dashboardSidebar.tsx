...
export const exactMatchSidebarRoutes = new Set([
  ...
  '/dashboard/super-admin/access-control',
  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'إدارة الوصول والصلاحيات', href: '/dashboard/super-admin/access-control', icon: KeyRound },
  ...
  return [
    ...
    // ── Group 4: العمليات والطلبات ────────────────────────────────────────
    {
      ...
      items: [
        ...
        { label: 'استيراد الكتالوج',        href: '/dashboard/admin/catalog-import',          icon: FileText       },
