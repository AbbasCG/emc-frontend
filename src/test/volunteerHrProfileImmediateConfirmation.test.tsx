...
function submittedProfile(overrides: Partial<VolunteerHrProfile> = {}): VolunteerHrProfile {
  return {
    ...
    skills: null, languages: [], education: null, university_specialization: null,
    experience: null, motivation: null, professional_bio: null,
...
async function fillMinimalForm(user: ReturnType<typeof userEvent.setup>) {
  ...
  // Both consents must be explicitly answered — no pre-checked default.
