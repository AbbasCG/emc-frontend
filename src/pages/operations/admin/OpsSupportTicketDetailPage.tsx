...
function CopyBtn({ text }: { text: string }) {
  ...
  return (
    <button
      ...
      onClick={(e) => void go(e)}
      title="نسخ"
      className="flex h-7 w-7 shrink-0 items-center justify-center rounded-lg border border-slate-200 bg-white text-slate-400 transition hover:border-[#0077B6]/40 hover:text-[#0077B6]"
    >
...
function SCard({
  ...
  return (
    <motion.div
      ...
      className={`overflow-hidden rounded-[20px] bg-white shadow-[0_1px_16px_rgba(12,42,75,0.07)] ring-1 ring-slate-100 ${className}`}
    >
      {children}
    </motion.div>
  )
...
function MCard({ children, delay = 0 }: { children: React.ReactNode; delay?: number }) {
  return (
    <motion.div
      ...
      className="overflow-hidden rounded-[20px] bg-white shadow-[0_1px_16px_rgba(12,42,75,0.07)] ring-1 ring-slate-100"
    >
      {children}
    </motion.div>
  )
...
function AssignmentCard({
  ...
  return (
    <SCard delay={0.06}>
      <SCardHeader icon={UserPlus} title="تعيين التذكرة" color="text-[#0077B6]" bg="bg-[#0077B6]/10" />
      <div className="p-4">
        {/* Trigger */}
        <div
          ref={triggerRef}
          ...
          className={`flex cursor-pointer items-center gap-3 rounded-xl border px-4 py-3 transition select-none ${
            open ? 'border-[#0077B6]/50 ring-2 ring-[#0077B6]/15' : 'border-slate-200 hover:border-slate-300'
          }`}
        >
          {currentAssignee ? (
            <>
          ...
          <div className="border-b border-slate-100 p-3">
            <div className="relative">
              ...
              <input
                ...
                className="h-8 w-full rounded-lg border border-slate-200 bg-slate-50 pe-8 ps-3 text-[12px] font-medium placeholder:text-slate-400 focus:border-[#0077B6]/40 focus:outline-none"
              />
            </div>
          </div>
                  ...
                  {users.map((u) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {isAssigning ? (
                          <RefreshCw size={12} className="animate-spin text-[#0077B6]" />
                        ) : isCurrent ? (
...
function ApplicantCard({
  ...
  return (
    <SCard delay={0.16}>
      <SCardHeader icon={User} title="مقدم الطلب" color="text-[#0077B6]" bg="bg-[#0077B6]/10" />
      <div className="p-4 space-y-4">
        ...
        <div className="space-y-2">
          {email && (
            <div className="flex items-center gap-2.5 rounded-xl border border-slate-100 bg-slate-50/50 px-3 py-2.5">
              ...
              <a
                href={`mailto:${email}`}
                className="min-w-0 flex-1 truncate text-[12px] font-semibold text-[#0077B6] hover:underline"
              >
                {email}
              </a>
              <CopyBtn text={email} />
        ...
        <div className="flex gap-2">
          {email && (
            <a
              href={`mailto:${email}`}
              className="flex flex-1 items-center justify-center gap-1.5 rounded-xl bg-[#0077B6]/8 py-2.5 text-[12px] font-bold text-[#0077B6] transition hover:bg-[#0077B6]/15"
            >
              <Mail size={12} />
              مراسلة
            </a>
  ...
  if (isMe) {
    return (
      <motion.div
        ...
        className="flex justify-start"
      >
        <div className="w-full max-w-[75%] overflow-hidden rounded-2xl border border-[#0077B6]/30 bg-white shadow-sm">
          {/* Blue accent bar */}
          <div className="h-[3px] bg-[#0077B6]" />
          {/* Header */}
          ...
          <div className="flex items-center justify-end gap-1.5 border-t border-slate-100 px-5 py-2.5">
            ...
            <CheckCheck size={12} className="text-[#0077B6]/60" />
          </div>
        </div>
      </motion.div>
    )
...
export default function OpsSupportTicketDetailPage() {
  ...
  /* ── Guards ─────────────────────────────────────────────────────────── */
  if (!Number.isFinite(tid)) return <p className="text-center font-black text-[#0C2A4B]">معرف غير صالح</p>
  ...
  if (loadError) {
    return (
      <div dir="rtl" className="rounded-2xl border border-rose-200 bg-rose-50 p-10 text-center">
        ...
        <button type="button" onClick={() => void loadTicket()} className="mt-5 rounded-xl bg-[#0C2A4B] px-6 py-2.5 text-sm font-black text-white">
          إعادة المحاولة
        </button>
      </div>
    )
    ...
    <>
      ...
      >
        ...
        <div className="sticky top-0 z-20 border-b border-slate-200/70 bg-[#F0F4F8]/90 backdrop-blur-sm">
          <div className="mx-auto flex max-w-[1700px] items-center gap-2.5 px-3 py-2.5 sm:px-6 sm:py-3 lg:px-8">
            <Link
              ...
              className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl border border-slate-200 bg-white text-slate-500 shadow-sm transition hover:border-[#0077B6]/40 hover:text-[#0077B6] sm:h-9 sm:w-9"
            >
              <ArrowLeft size={15} />
            </Link>
        ...
        <div className="mx-auto max-w-[1700px] space-y-4 px-3 py-4 pb-24 sm:space-y-6 sm:px-6 sm:py-6 lg:px-8">
          ...
          >
            {/* Glow orb */}
            <div className="pointer-events-none absolute -top-16 end-12 h-56 w-56 rounded-full bg-[#0077B6]/12 blur-3xl" />
            <div className="pointer-events-none absolute -bottom-8 start-8 h-40 w-40 rounded-full bg-[#F28C00]/8 blur-2xl" />
            ...
            <div className="relative flex flex-wrap items-start justify-between gap-6 lg:flex-nowrap">
              ...
              <div className="shrink-0">
                <motion.div
                  ...
                  className="flex h-20 w-20 items-center justify-center rounded-3xl bg-[#0077B6]/20 ring-1 ring-white/10"
                >
                  <LifeBuoy size={38} className="text-[#0077B6]" />
                </motion.div>
              </div>
            </div>
            ...
            <div className="mt-5 flex flex-wrap items-stretch gap-2 border-t border-white/[0.06] pt-4">
              <motion.button
                ...
                className="flex h-11 flex-1 items-center justify-center gap-1.5 rounded-xl bg-[#0077B6]/25 px-4 text-[13px] font-bold text-white ring-1 ring-[#0077B6]/40 transition hover:bg-[#0077B6]/35 sm:flex-none"
              >
                <Send size={13} />
                رد
              </motion.button>
                  ...
                  <form onSubmit={(e) => { void sendReply(e) }} className="space-y-3">
                    ...
                    <div
                      className={`overflow-hidden rounded-2xl border transition-all ${
                        internal
                          ...
                          : 'border-slate-200 bg-white focus-within:border-[#0077B6]/40 focus-within:ring-2 focus-within:ring-[#0077B6]/15'
                      }`}
                    >
                      <textarea
                        value={reply}
                    ...
                    <div className="flex flex-wrap items-center justify-between gap-3">
                      ...
                      <motion.button
                        ...
                        whileHover={{ y: -2 }}
                        whileTap={{ y: 0 }}
                        className="flex h-11 w-full items-center justify-center gap-2 rounded-2xl bg-[#0077B6] px-7 text-[13px] font-black text-white shadow-md shadow-[#0077B6]/20 transition hover:bg-[#0077B6] hover:shadow-lg disabled:cursor-not-allowed disabled:opacity-50 sm:w-auto"
                      >
