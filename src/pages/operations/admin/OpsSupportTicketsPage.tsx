      ...
      <AnimatePresence>
        {show && (
          <motion.div
            ...
            className="pointer-events-none absolute bottom-full left-1/2 z-50 mb-2 -translate-x-1/2 whitespace-nowrap rounded-lg bg-[#22334A] px-2.5 py-1.5 text-[11px] font-bold text-white shadow-lg"
          >
            {label}
          </motion.div>
        )}
...
function KpiCard({ icon: Icon, label, value, accent, iconBg, iconColor, delay = 0 }: KpiProps) {
  ...
  return (
    <motion.div
      ...
      className="relative overflow-hidden rounded-2xl bg-white p-5 shadow-[0_2px_16px_rgba(34,51,74,0.07)] ring-1 ring-slate-100 transition-shadow hover:shadow-[0_4px_28px_rgba(34,51,74,0.12)]"
    >
      ...
      <p className="text-[28px] font-black leading-none text-[#22334A]">{count.toLocaleString('en-US')}</p>
...
function TicketCard({
  ...
  return (
    <motion.div
      ...
      className="group relative overflow-hidden rounded-2xl bg-white shadow-[0_1px_12px_rgba(34,51,74,0.06)] ring-1 ring-slate-100 transition-shadow hover:shadow-[0_4px_24px_rgba(34,51,74,0.12)] hover:ring-slate-200 cursor-pointer"
      onClick={onOpen}
    >
      ...
      <div className="p-5 ps-6">
        ...
        {/* Row 2: title */}
        <h3 className="mb-3 text-[15px] font-black leading-snug text-[#22334A] group-hover:text-[#2691C2] transition-colors line-clamp-2">
          {t.subject}
        </h3>
        ...
        <div className="mb-3 flex flex-wrap items-center gap-x-4 gap-y-1">
          <div className="flex items-center gap-1.5 text-[12px] text-slate-500">
            ...
            <span className="font-semibold text-[#22334A]">{t.full_name ?? t.name ?? '—'}</span>
          </div>
          {t.email && (
  ...
  return (
    <div dir="rtl" className="min-h-screen bg-[#F0F4F8]">
      ...
      >
        ...
        <div className="pointer-events-none absolute -top-20 end-40 h-72 w-72 rounded-full bg-[#2691C2]/10 blur-3xl" />
        <div className="pointer-events-none absolute -bottom-10 start-20 h-48 w-48 rounded-full bg-[#EC943C]/8 blur-3xl" />
          ...
          <div className="flex flex-wrap items-center justify-between gap-5">
            ...
            <div className="flex items-center gap-4">
              <motion.div
                ...
                className="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-[#2691C2]/20 ring-1 ring-white/10"
              >
                <LifeBuoy size={26} className="text-[#2691C2]" />
              </motion.div>
              <div>
      ...
      <div className="mx-auto max-w-[1560px] space-y-5 px-4 py-6 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-5">
          {loading ? (
            ...
            <>
              <KpiCard icon={Inbox}        label="إجمالي التذاكر"  value={stats.total}      accent="bg-gradient-to-l from-[#2691C2] to-sky-400"    iconBg="bg-sky-50"     iconColor="text-sky-600"     delay={0} />
              ...
              <KpiCard icon={TrendingUp}   label="أولوية عالية"     value={stats.high}       accent="bg-gradient-to-l from-[#EC943C] to-orange-400"  iconBg="bg-orange-50"  iconColor="text-orange-600"  delay={0.24} />
            </>
          )}
        </div>
        ...
        <motion.div
          ...
          className="rounded-2xl bg-white p-4 shadow-[0_2px_12px_rgba(34,51,74,0.06)] ring-1 ring-slate-100"
        >
          <div className="flex flex-wrap items-center gap-2.5">
            ...
            <div className="relative min-w-[200px] flex-1">
              ...
              <input
                ...
                className="h-10 w-full rounded-xl border border-slate-200 bg-slate-50/50 pe-10 ps-4 text-[14px] font-medium text-[#22334A] placeholder:text-slate-400 transition focus:border-[#2691C2]/40 focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#2691C2]/15"
              />
            </div>
            ...
            <button
              ...
              className={`flex h-10 items-center gap-2 rounded-xl border px-4 text-[13px] font-bold transition-all ${
                showFilters || activeFilters > 0
                  ? 'border-[#2691C2]/40 bg-[#2691C2]/8 text-[#2691C2]'
            ...
            >
              ...
              فلاتر
              {activeFilters > 0 && (
                <span className="flex h-4.5 w-4.5 items-center justify-center rounded-full bg-[#2691C2] text-[10px] font-black text-white px-1">
                  {activeFilters}
                </span>
              )}
              <ChevronDown
                ...
                <div className="mt-4 grid grid-cols-1 gap-3 border-t border-slate-100 pt-4 sm:grid-cols-3">
                  <div>
                    ...
                    <select
                      ...
                      className="h-9 w-full rounded-xl border border-slate-200 bg-slate-50 px-3 text-[13px] font-medium text-slate-700 focus:border-[#2691C2]/40 focus:outline-none"
                    >
        ...
        {!loading && (
          <p className="text-[13px] font-medium text-slate-400">
            <span className="font-black text-[#22334A]">{tickets.length}</span> تذكرة
        ...
        {loading ? (
          ...
          >
            <div className="mb-5 flex h-20 w-20 items-center justify-center rounded-3xl bg-white shadow-[0_2px_20px_rgba(34,51,74,0.08)] ring-1 ring-slate-100">
            ...
            <div className="mt-5 flex gap-3">
              {activeFilters > 0 && (
                <button
                  type="button"
                  onClick={clearFilters}
                  className="rounded-xl bg-[#2691C2]/10 px-5 py-2.5 text-[13px] font-bold text-[#2691C2] transition hover:bg-[#2691C2]/20"
                >
                  مسح الفلاتر
                </button>
              )}
        ...
        {lastPage > 1 && (
          ...
          >
            <button
              ...
              disabled={page === 1}
              className="flex h-10 w-10 items-center justify-center rounded-xl border border-slate-200 bg-white text-slate-500 shadow-sm transition hover:border-[#2691C2]/40 hover:text-[#2691C2] disabled:opacity-40"
            >
                ...
                p === '…' ? (
                  ...
                  <button
                    ...
                    className={`flex h-10 w-10 items-center justify-center rounded-xl border text-[14px] font-bold shadow-sm transition ${
                      page === p
                        ? 'border-[#2691C2] bg-[#2691C2] text-white shadow-[#2691C2]/20'
