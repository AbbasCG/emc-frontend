...
import { BadgeCheck, Briefcase, Compass, Send } from 'lucide-react'
 ...
 * نموذج واحد قصير: الهوية، التخصص والخبرة، الدافع. بلا حساب وبلا خطوات.
 */
...
export default function ConsultantApply() {
  ...
  return (
    <div className="bg-paper pt-20" dir="rtl">
      <PublicSeo
        title="قدّم كمستشار"
        description="انضم إلى إدارة المستشارين في EMC وشارك خبرتك في تطوير التعليم العربي."
        path="/consultants"
      />
      <PageHeader
        title="قدّم كمستشار"
        ...
        <div className="grid gap-12 lg:grid-cols-[1fr_1.4fr]">
          ...
          <div>
            ...
            <p className="mt-5 text-sm leading-7 text-ink-400">
              إدارة المستشارين تجمع أصحاب الخبرة الذين يوجهون برامج EMC ومساراتها
              وقراراتها التشغيلية. ساعات قليلة من وقتك تنعكس على آلاف المتعلمين.
            </p>
            <ul className="mt-8 space-y-5">
              {[
                { icon: Compass, text: 'توجيه استراتيجي لبرنامج أو مسار في تخصصك' },
                { icon: Briefcase, text: 'جلسات مراجعة دورية مرنة تناسب وقتك' },
          ...
          {submitted ? (
            ...
            <form onSubmit={(e) => void handleSubmit(e)} className="grid gap-4 rounded-2xl border border-line bg-white p-6 sm:p-8" noValidate>
              ...
              <label className="grid gap-1.5 text-xs font-black text-ink-500">
                ...
                <input placeholder="مثال: 4 ساعات أسبوعياً" value={form.availability} onChange={(e) => set('availability', e.target.value)} className={inputClass} />
              </label>
