              ...
              <div className="space-y-3">
                {selected ? (
                  ...
                  <div className="relative">
                    <div className="flex items-center gap-2 rounded-xl border border-slate-200 bg-slate-50 px-3 py-2.5 transition focus-within:border-[#2691C2] focus-within:ring-2 focus-within:ring-[#2691C2]/20">
...
const inputCls =
  'w-full rounded-xl border border-slate-200 bg-slate-50 px-3.5 py-2.5 text-sm font-semibold transition focus:border-[#2691C2] focus:outline-none focus:ring-2 focus:ring-[#2691C2]/20'
