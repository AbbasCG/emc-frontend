    ...
    <div className="min-h-screen bg-[#F1F5F9] p-6" dir="rtl">
      ...
      <div className="mb-6 flex items-center justify-between flex-wrap gap-3">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-black text-[#22334A]">إعدادات الحضور</h1>
              ...
              <label key={f.key} className="block">
                ...
                <div className="flex items-center gap-2">
                  <input
                    ...
                    className={`w-full rounded-xl border px-3 py-2 text-sm text-[#22334A] focus:outline-none focus:ring-2 focus:ring-[#2691C2]/40 ${
