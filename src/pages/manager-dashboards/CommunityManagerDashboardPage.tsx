...
export default function CommunityManagerDashboardPage() {
  return (
    <div dir="rtl" className="space-y-8 text-right">
      <DashboardHero
        ...
        actions={
          <>
            <Link to="/dashboard/admin/volunteers" className="rounded-2xl border border-white/[0.14] bg-white/[0.10] px-4 py-2 text-[11px] font-black text-white backdrop-blur-sm transition hover:border-white/[0.3] hover:bg-white/[0.18]">المتطوعون</Link>
      ...
      <section className="rounded-2xl border border-deepBlue/[0.06] bg-white p-6 shadow-sm ring-1 ring-deepBlue/[0.03]">
        <div className="mb-4 flex items-center gap-2">
          ...
          <h2 className="text-sm font-black text-deepBlue">المجتمع والنشاطات</h2>
        </div>
        <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
          <QuickLink href="/dashboard/admin/volunteers"          label="المتطوعون"                icon={Users}         />
          <QuickLink href="/dashboard/admin/tasks"               label="المهام"                   icon={ClipboardList} />
          <QuickLink href="/dashboard/admin/meetings"            label="الاجتماعات"               icon={Calendar}      />
          <QuickLink href="/dashboard/admin/forms"               label="النماذج"                  icon={FileText}      />
          <QuickLink href="/dashboard/admin/reports"             label="التقارير"                 icon={FileBarChart}  />
