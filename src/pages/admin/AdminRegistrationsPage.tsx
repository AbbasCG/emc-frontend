...
function DetailDrawer({
  ...
  return (
    <>
      ...
      >
        {/* Header */}
        <div className="border-b border-slate-100 bg-gradient-to-l from-[#1E2D40] to-[#2691C2] px-6 py-5 text-white">
          ...
          {loading ? (
            ...
            <div className="divide-y divide-slate-100">
              ...
              <Section title="معلومات الطالب" icon={<User size={14} />}>
                ...
                <Field label="البريد"           value={<a href={`mailto:${detail.email}`} className="text-[#2691C2] hover:underline">{detail.email ?? '—'}</a>} />
              ...
              {detail.progress && (
                <Section title="تقدم الطالب" icon={<TrendingUp size={14} />}>
                  <ProgressBar label="التقدم العام"      pct={detail.progress.percentage} color="bg-[#2691C2]" />
  ...
  return (
    <div className="px-6 py-5">
      <div className="mb-3.5 flex items-center gap-2 text-[#1E2D40]">
        <span className="text-[#2691C2]">{icon}</span>
...
export default function AdminRegistrationsPage() {
  ...
  return (
    <div dir="rtl" className="space-y-5 text-right">
      {/* ── Header ── */}
      <div className="rounded-2xl bg-gradient-to-l from-[#1E2D40] via-[#1a3a54] to-[#2691C2] p-7 text-white shadow-xl">
        ...
        <div className="flex flex-wrap items-center gap-2.5">
          ...
          <div className="relative min-w-[200px] flex-1">
            ...
            <input
              ...
              className="w-full rounded-xl border border-slate-200 bg-slate-50 py-2.5 pr-9 pl-3 text-[13px] outline-none focus:border-[#2691C2] focus:ring-2 focus:ring-[#2691C2]/10"
            />
          </div>
          ...
          <select
            ...
            className="rounded-xl border border-slate-200 bg-slate-50 px-3 py-2.5 text-[13px] outline-none focus:border-[#2691C2]"
          >
          ...
          <button
            type="button"
            onClick={() => void load()}
            className="flex items-center gap-1.5 rounded-xl bg-[#2691C2] px-5 py-2.5 text-[12px] font-black text-white shadow-sm hover:bg-[#1E7FAD]"
          >
            <Search size={12} /> بحث
          </button>
                ...
                ? (
                  <tr>
                    <td colSpan={isAdmin ? 6 : 5} className="py-16 text-center">
                      ...
                      {hasFilters && (
                        <button type="button" onClick={resetFilters} className="mt-3 text-[12px] text-[#2691C2] hover:underline">
                          إعادة تعيين الفلاتر
                        </button>
                      )}
                    </td>
                  ...
                  return (
                    <tr
                      ...
                      className={[
                        ...
                        'hover:bg-[#2691C2]/[0.025] hover:shadow-sm',
                    ...
                    >
                      <td className="px-5 py-3.5">
                        <div className="flex items-center gap-2.5">
                          <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-gradient-to-br from-[#2691C2]/80 to-[#1E2D40] text-[11px] font-black text-white">
