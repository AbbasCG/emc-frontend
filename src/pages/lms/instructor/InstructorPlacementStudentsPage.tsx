        ...
        <div className="grid gap-4 lg:grid-cols-[280px_1fr]">
          ...
          <div className="min-w-0 space-y-3">
            <button
              ...
              className="inline-flex w-full items-center justify-center gap-2 rounded-xl border border-slate-200 bg-white px-4 py-2.5 text-[12px] font-black text-deepBlue shadow-sm transition hover:border-[#2691C2]/30 lg:hidden"
            >
