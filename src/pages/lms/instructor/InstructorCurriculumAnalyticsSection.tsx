  ...
  return (
    <div dir="rtl" className="space-y-4">
      <div className="flex items-center gap-2">
        <BarChart3 className="h-4 w-4 text-[#2691C2]" />
              ...
              <tbody className="divide-y divide-slate-100">
                {modules.map((m) => (
                  <tr key={m.id}>
                    ...
                    <td className="px-3 py-2 font-black text-[#2691C2]">{m.completion_percentage}%</td>
                  </tr>
                ))}
              </tbody>
            </table>
              ...
              <tbody className="divide-y divide-slate-100">
                {lessons.map((l) => (
                  <tr key={l.id}>
                    ...
                    <td className="px-3 py-2 font-black text-[#2691C2]">{l.completion_percentage}%</td>
                  </tr>
                ))}
              </tbody>
            </table>
              ...
              <tbody className="divide-y divide-slate-100">
                {materials.map((m) => (
                  <tr key={m.id}>
                    ...
                    <td className="px-3 py-2 font-black text-[#2691C2]">{m.total_interactions}</td>
                  </tr>
                ))}
              </tbody>
            </table>
