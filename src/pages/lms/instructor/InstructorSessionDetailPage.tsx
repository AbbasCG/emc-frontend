            ...
            <div className="space-y-3 rounded-2xl border border-slate-200 bg-white p-4">
              ...
              <div>
                ...
                <textarea value={form.description} onChange={(e) => setForm((f) => ({ ...f, description: e.target.value }))} rows={2}
                  className="mt-1 w-full rounded-xl border border-slate-200 px-3 py-2 text-[12px] font-semibold text-deepBlue outline-none focus:border-[#0077B6]" />
              </div>
              ...
              <div className="rounded-2xl border border-slate-200 bg-white p-4">
                ...
                <div className="mt-2 space-y-2">
                  ...
                  {session.recording_url && (
                    <a href={session.recording_url} target="_blank" rel="noreferrer" className="block text-[11px] font-bold text-[#0077B6] underline">
                      عرض التسجيل
                    </a>
                  )}
                </div>
