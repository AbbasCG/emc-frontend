    ...
    <div className="space-y-5 pb-16 font-[Cairo,sans-serif]" dir="rtl">
      ...
      {loading ? (
        ...
        <div className="overflow-hidden rounded-2xl bg-white shadow-sm ring-1 ring-slate-100">
          {selected.size > 0 && (
            <div className="flex flex-wrap items-center gap-2 border-b border-slate-100 bg-[#0077B6]/[0.04] px-4 py-2.5">
              <span className="text-[11px] font-black text-[#0C2A4B]">{selected.size} محدد</span>
              <button
                type="button"
                disabled={bulkBusy}
