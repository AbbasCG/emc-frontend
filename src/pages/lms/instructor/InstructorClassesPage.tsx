          ...
          <div className="flex shrink-0 items-center gap-2">
            ...
            {selectedCourse && (
              <button
                type="button"
                onClick={openCreate}
                className="inline-flex items-center gap-1.5 rounded-xl bg-[#EC943C] px-4 py-2 text-[12px] font-bold text-white shadow-md transition hover:brightness-105"
              >
        ...
        <>
          {loading ? (
            ...
            <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 xl:grid-cols-6">
              <KpiCard index={0} icon={Layers} label="إجمالي الصفوف" value={kpis.total} tone="text-[#2691C2] bg-[#2691C2]/[0.08]" />
              ...
              <KpiCard index={3} icon={Armchair} label="مقاعد متاحة" value={kpis.seats} tone="text-[#EC943C] bg-[#EC943C]/10" />
          ...
          <div className="grid gap-5 lg:grid-cols-[1fr_340px] xl:grid-cols-[1fr_360px]">
            <section>
              <div className="mb-4 flex items-center justify-between">
                <div>
                  <h2 className="text-[15px] font-bold text-[#22334A]">الصفوف والمجموعات</h2>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#0F172A]/50 p-4 backdrop-blur-sm" dir="rtl">
            ...
            >
              <div className="mb-5 flex items-center justify-between">
                <h2 className="text-[16px] font-bold text-[#22334A]">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    dir="rtl"
                    className="h-10 w-full rounded-xl border border-[#22334A]/10 bg-[#F8FAFC] px-4 text-[13px] font-semibold text-[#22334A] outline-none focus:border-[#2691C2] focus:bg-white focus:ring-2 focus:ring-[#2691C2]/15"
                  />
                </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <select
                      ...
                      dir="rtl"
                      className="h-10 w-full rounded-xl border border-[#22334A]/10 bg-white px-3 text-[12px] font-bold text-[#22334A] outline-none focus:border-[#2691C2]"
                    >
                  ...
                  <div>
                    ...
                    <input
                      ...
                      dir="ltr"
                      className="h-10 w-full rounded-xl border border-[#22334A]/10 bg-white px-4 text-[13px] font-semibold outline-none focus:border-[#2691C2]"
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      className="h-10 w-full rounded-xl border border-[#22334A]/10 bg-white px-4 text-[12px] font-bold outline-none focus:border-[#2691C2]"
                    />
                  </div>
                </div>
                ...
                <div>
                  <div className="mb-2 flex items-center justify-between">
                    ...
                    <button
                      ...
                      className="inline-flex items-center gap-1 rounded-lg bg-[#2691C2]/[0.08] px-2.5 py-1 text-[10px] font-bold text-[#2691C2] transition hover:bg-[#2691C2]/[0.15]"
                    >
                  ...
                  <div className="space-y-2">
                    {groupForm.schedules.map((row, i) => (
                      <div key={i} className="rounded-xl border border-[#22334A]/10 bg-[#F8FAFC] p-2.5">
                        <div className="grid grid-cols-2 gap-2 sm:grid-cols-4">
                          <select
                            value={row.day_of_week}
                            onChange={(e) => updateScheduleRow(i, { day_of_week: e.target.value })}
                            dir="rtl"
                            className="h-9 w-full rounded-lg border border-[#22334A]/10 bg-white px-2 text-[11px] font-bold outline-none focus:border-[#2691C2]"
                          >
              ...
              <div className="mt-6 flex gap-3">
                <button
                  ...
                  className="flex flex-1 items-center justify-center gap-2 rounded-xl bg-[#22334A] py-3 text-[13px] font-bold text-white transition hover:bg-[#2691C2] disabled:opacity-50"
                >
                ...
                <button
                  type="button"
                  onClick={() => setShowCreate(false)}
                  className="rounded-xl border border-[#22334A]/10 px-4 py-3 text-[13px] font-bold text-[#22334A]/70 hover:bg-[#F8FAFC]"
                >
                  إلغاء
                </button>
              </div>
