  ...
  const actions = [
    {
      ...
      cls:   'text-[#0077B6] hover:bg-[#0077B6]/[0.08]',
    },
    {
      label: 'الحضور',
      icon:  UserCheck,
    ...
    },
    {
      ...
      cls:   'text-[#F28C00] hover:bg-orange-50',
    },
    {
      label: 'المحتوى',
      icon:  Layers,
    ...
    >
      ...
      <div className="relative h-40 overflow-hidden">
        {imageUrl ? (
          ...
          <div className="absolute inset-0 bg-gradient-to-bl from-[#0C2A4B] via-[#1e3350] to-[#0077B6]">
            <div aria-hidden className="absolute -right-8 -top-8 h-32 w-32 rounded-full bg-[#F28C00]/15 blur-3xl" />
      ...
      <div className="flex flex-1 flex-col gap-3 p-4 text-right" dir="rtl">
          ...
          <div className="flex flex-wrap items-center gap-3 text-[11px] font-semibold text-deepBlue/55">
            {dateLabel && (
              <span className="flex items-center gap-1">
                <CalendarDays className="h-3.5 w-3.5 text-[#0077B6]/70 shrink-0" />
                {dateLabel}
              </span>
            )}
            {timeLabel && (
              <span className="flex items-center gap-1">
                <Clock className="h-3.5 w-3.5 text-[#0077B6]/70 shrink-0" />
                {timeLabel}
              </span>
            )}
          </div>
        ...
        <div className="flex flex-wrap gap-1.5">
          <span className="inline-flex items-center gap-1 rounded-xl bg-sky-50 px-2.5 py-1 text-[10px] font-black text-[#0077B6]">
          ...
          {needsPlacement && written != null && (
            <span className="inline-flex items-center gap-1 rounded-xl bg-orange-50 px-2.5 py-1 text-[10px] font-black text-[#F28C00]">
