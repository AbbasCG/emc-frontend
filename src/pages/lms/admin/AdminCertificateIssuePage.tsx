          ...
          <div key={i} className="flex items-center">
            <div className="flex flex-col items-center gap-1.5">
              <div className={[
                ...
                active ? 'bg-[#2691C2] text-white shadow-lg shadow-[#2691C2]/30 scale-110' : '',
              ...
              <span className={[
                ...
                active ? 'text-[#2691C2]' : done ? 'text-emerald-500' : 'text-slate-400',
              ].join(' ')}>
                {label}
              </span>
            </div>
...
function ContentSummaryCard({
  ...
  return (
    <div className="rounded-2xl border border-[#2691C2]/15 bg-gradient-to-l from-[#2691C2]/5 via-white to-slate-50 p-5">
      <p className="text-[11px] font-black uppercase tracking-wide text-[#2691C2]">المحتوى المختار</p>
  ...
  return (
    <AdminLmsShell title="إصدار الشهادات" description="إصدار شهادات فردية أو جماعية للمتعلمين المؤهلين" breadcrumb="الشهادات / إصدار">
      <div className="min-h-screen bg-slate-50 pb-16" dir="rtl">
        ...
        {/* ── Hero ── */}
        <div className="bg-gradient-to-l from-[#1E2D40] via-[#2691C2] to-[#1a4a6e] px-6 py-10 text-center text-white">
                ...
                <div className="space-y-8">
                      ...
                      {CERT_TYPES.map((ct) => (
                        <button
                          ...
                          className={[
                            ...
                            certType === ct.value
                              ? 'border-[#2691C2] bg-[#2691C2]/5 shadow-md shadow-[#2691C2]/10'
                              : 'border-slate-200 hover:border-[#2691C2]/30',
                          ].join(' ')}
                        >
                          <div className="text-lg mb-1">{ct.icon}</div>
                          <p className={`text-[11px] font-black ${certType === ct.value ? 'text-[#2691C2]' : 'text-[#1E2D40]'}`}>
                            {ct.label}
                          </p>
                          <p className="mt-0.5 text-[10px] leading-tight text-slate-400">{ct.desc}</p>
                          {certType === ct.value && (
                            <div className="mt-2 flex justify-end">
                              <Check size={11} className="text-[#2691C2]" strokeWidth={3} />
                            </div>
                          )}
                        </button>
                      ))}
                  ...
                  {needsEntity && (
                    <div>
                      ...
                      {loadingEnt ? (
                        ...
                        <div className="flex items-center justify-between rounded-xl border-2 border-[#2691C2] bg-[#2691C2]/5 px-4 py-3">
                        ...
                        <div className="space-y-2">
                          <div className="relative">
                            ...
                            <input
                              ...
                              className="w-full rounded-xl border border-slate-200 bg-slate-50 py-2.5 pr-9 pl-4 text-[13px] outline-none focus:border-[#2691C2] focus:ring-2 focus:ring-[#2691C2]/10"
                            />
                          </div>
                    ...
                    <div>
                      ...
                      <div className="grid gap-2 sm:grid-cols-2">
                        <button
                          ...
                          className={`rounded-xl border-2 px-4 py-3 text-right transition-all ${!templateId ? 'border-[#2691C2] bg-[#2691C2]/5' : 'border-slate-200'}`}
                        >
                        ...
                        {templates.map((t) => (
                          <button
                            ...
                            className={`rounded-xl border-2 px-4 py-3 text-right transition-all ${templateId === t.id ? 'border-[#2691C2] bg-[#2691C2]/5' : 'border-slate-200'}`}
                          >
                  ...
                  <div className="flex items-center gap-3 pt-2">
                    <button
                      ...
                      className="flex items-center gap-2 rounded-xl bg-[#2691C2] px-6 py-3 text-[13px] font-black text-white shadow-lg shadow-[#2691C2]/25 transition-all hover:bg-[#1E7FAD] hover:shadow-xl disabled:cursor-not-allowed disabled:opacity-40"
                    >
                ...
                <div className="space-y-6">
                  ...
                  {loadingElig ? (
                    ...
                    <>
                      ...
                      <div className="flex flex-wrap items-center gap-2">
                        ...
                        <span className="mr-auto text-[11px] font-black text-[#2691C2]">{selected.size} محدد</span>
                      </div>
                      ...
                      <div className="flex flex-wrap items-center gap-2">
                        <div className="relative flex-1 min-w-[150px]">
                          ...
                          <input
                            ...
                            className="w-full rounded-xl border border-slate-200 bg-slate-50 py-2 pr-8 pl-3 text-[12px] outline-none focus:border-[#2691C2]"
                          />
                        </div>
                        {(['all', 'eligible', 'ineligible', 'issued'] as const).map((f) => (
                          <button key={f} type="button" onClick={() => setFilter(f)}
                            className={`rounded-lg px-3 py-1.5 text-[11px] font-black transition-all ${filter === f ? 'bg-[#2691C2] text-white' : 'bg-slate-100 text-slate-600 hover:bg-slate-200'}`}>
                            ...
                            <div
                              ...
                              onClick={() => {
                                ...
                                setSelected((prev) => {
                                  ...
                                  n.has(s.user.id) ? n.delete(s.user.id) : n.add(s.user.id)
                                  return n
                                })
                              }}
                              className={[
                                ...
                                isSel ? 'border-[#2691C2] bg-[#2691C2]/4 shadow-sm' : 'border-slate-200 hover:border-[#2691C2]/30 hover:bg-slate-50',
                                !canSelect ? 'opacity-70' : '',
                              ].join(' ')}
                            >
                              <div className={`flex h-5 w-5 shrink-0 items-center justify-center rounded-md border-2 transition-all ${isSel ? 'border-[#2691C2] bg-[#2691C2]' : 'border-slate-300'}`}>
                                {isSel && <Check size={10} strokeWidth={3} className="text-white" />}
                              </div>
                              <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-[#2691C2] to-[#1E2D40] text-[11px] font-black text-white">
                  ...
                  <div className="flex items-center justify-between border-t border-slate-100 pt-5">
                    ...
                    <button type="button" onClick={() => goStep(2)} disabled={selected.size === 0}
                      className="flex items-center gap-2 rounded-xl bg-[#2691C2] px-6 py-2.5 text-[13px] font-black text-white shadow-md shadow-[#2691C2]/20 hover:bg-[#1E7FAD] disabled:cursor-not-allowed disabled:opacity-40">
                    ...
                    <div className="py-10 text-center space-y-5">
                      ...
                      <div>
                        ...
                        <p className="mt-1.5 text-[13px] text-slate-500">
                          رقم الدفعة: <span className="font-mono font-black text-[#2691C2]">{issuedBatch.batch_code}</span>
                        </p>
                      ...
                      <div className="flex justify-center gap-3">
                        <button type="button" onClick={() => navigate('/dashboard/admin/certificates')}
                          className="rounded-xl bg-[#2691C2] px-5 py-2.5 text-[13px] font-black text-white hover:bg-[#1E7FAD]">
                          عرض الشهادات
                        </button>
