...
function CopyBtn({ text }: { text: string }) {
  ...
  return (
    <button
      ...
      className="flex h-5 w-5 shrink-0 items-center justify-center rounded-md border border-slate-200 bg-white text-slate-400 transition hover:border-[#2691C2]/40 hover:text-[#2691C2]"
    >
  ...
  return (
    <div dir="rtl" className="space-y-6">
      ...
      >
        <div className="flex items-center gap-3">
          <div className="flex h-10 w-10 items-center justify-center rounded-2xl bg-[#2691C2]/10">
            <FileText size={20} className="text-[#2691C2]" />
          </div>
          <div>
      ...
      <div className="grid grid-cols-2 gap-3 md:grid-cols-4">
        <KpiCard icon={FileText}    label="إجمالي الفواتير"   value={String(invoices.length)}           accent="border-t-[#2691C2]"   />
                  ...
                  >
                    ...
                    <td className="px-4 py-3">
                      {inv.has_pdf ? (
                        <button
                          type="button"
                          className="flex items-center gap-1 rounded-xl border border-deepBlue/[0.08] bg-white px-3 py-1.5 text-[11px] font-black text-[#2691C2] shadow-sm transition hover:border-[#2691C2]/30 hover:bg-[#2691C2]/[0.05]"
                        >
                          <Download size={11} />
                          تحميل
                        </button>
