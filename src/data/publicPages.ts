...
export const departments10: PublicDepartment[] = [
  ...
  },
  {
    ...
    description: { ar: 'برامج مجتمعية تدعم الوعي والصحة والاندماج بكرامة.' },
    responsibilities: [
      { ar: 'مبادرات مجتمعية موسمية' },
  ...
  },
  {
    ...
    description: { ar: 'معايير جودة، مراجعة مستمرة، وحوكمة قرارات واضحة.' },
    responsibilities: [
      { ar: 'سياسات الجودة والمخاطر' },
