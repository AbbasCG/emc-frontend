  ...
  sections: [
    {
      ...
      blocks: [
        {
          type: 'p',
          text: 'ملفات تعريف الارتباط (Cookies) هي ملفات نصية صغيرة تُخزَّن على جهازك عند زيارة موقعنا. تساعدنا على تشغيل المنصة، تذكر تفضيلاتك، و—بموافقتك—قياس الاستخدام والتسويق.',
        },
      ],
    },
    {
