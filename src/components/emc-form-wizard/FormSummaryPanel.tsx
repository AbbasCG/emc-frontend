  ...
  return (
    <div className={cn(EMC_WIZARD_GLASS_CARD, 'p-5 text-right', className)} dir="rtl">
      <div className="mb-4 flex items-center gap-2">
        <span className="grid h-9 w-9 place-items-center rounded-xl bg-[#EC943C]/15 text-[#EC943C] ring-1 ring-[#EC943C]/20">
      ...
      <ul className="space-y-2.5">
        {rows.map((r, i) => (
          <li
            key={`${r.label}-${i}`}
            className="flex flex-col gap-0.5 rounded-2xl border border-slate-200/80 bg-white/80 px-3 py-2.5 shadow-[0_8px_22px_-14px_rgba(34,51,74,0.2)]"
          >
