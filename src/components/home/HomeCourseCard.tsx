...
export default function HomeCourseCard({ course }: Props) {
  ...
  return (
    <motion.article
      ...
      className="group relative flex h-full flex-col overflow-hidden rounded-[1.375rem] border border-slate-200/80 bg-white shadow-[0_4px_20px_rgba(0,0,0,0.05)] ring-1 ring-slate-100/60 transition-all duration-300 hover:border-customBlue/40 hover:shadow-[0_16px_45px_-10px_rgba(38,145,194,0.18)]"
    >
