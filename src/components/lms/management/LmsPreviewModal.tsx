    ...
    <AnimatePresence>
      {state.kind !== 'idle' ?
        ...
        >
          ...
          >
            <div className="flex items-center justify-between gap-3 border-b border-[#0C2A4B]/8 bg-gradient-to-l from-[#0C2A4B]/5 to-white px-5 py-3">
              <p className="truncate text-sm font-black text-[#0C2A4B]">
              ...
              <div className="flex shrink-0 items-center gap-2">
                {state.kind === 'open' ?
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="flex items-center gap-1 rounded-xl border border-[#0C2A4B]/10 px-2.5 py-2 text-[11px] font-black text-[#0C2A4B]/55 transition hover:border-[#0077B6]/30 hover:text-[#0077B6]"
                ...
                <button
                  type="button"
                  onClick={onClose}
                  className="grid h-9 w-9 place-items-center rounded-xl border border-[#0C2A4B]/10 text-[#0C2A4B]/60 transition hover:bg-[#0C2A4B]/5"
                  aria-label="إغلاق"
                >
                  <X size={16} />
                </button>
            ...
            <div className="flex-1 overflow-hidden bg-[#f8fafc]">
              {state.kind === 'loading' ?
                <div className="flex h-full flex-col items-center justify-center gap-3 text-[#0C2A4B]/50">
                  <div className="h-10 w-10 animate-spin rounded-full border-4 border-[#0077B6]/20 border-t-[#0077B6]" />
