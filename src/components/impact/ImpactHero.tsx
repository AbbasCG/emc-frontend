...
export default function ImpactHero() {
  return (
    <section className="relative isolate overflow-hidden bg-deepBlue pt-[4.75rem] text-white lg:pt-[5rem]" dir="rtl">
      <div
        aria-hidden
        className="pointer-events-none absolute inset-0 bg-[linear-gradient(125deg,#22334a_0%,#1a2838_42%,#0f1c2b_78%),radial-gradient(ellipse_85%_60%_at_100%_-10%,rgba(38,145,194,0.45),transparent_55%),radial-gradient(ellipse_70%_50%_at_0%_100%,rgba(236,148,60,0.18),transparent_50%)]"
      />
      ...
      <div className="relative mx-auto max-w-[1540px] px-4 py-14 sm:px-6 lg:px-10 lg:py-16">
        ...
        <div className="mt-12 grid gap-6 lg:grid-cols-[minmax(0,1fr)_minmax(0,420px)] lg:items-end">
          ...
          >
            <div
              aria-hidden
              className="pointer-events-none absolute inset-0 bg-[linear-gradient(160deg,rgba(38,145,194,0.15),transparent_45%)]"
            />
