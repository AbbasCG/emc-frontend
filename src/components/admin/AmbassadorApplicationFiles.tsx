...
function FileCard({
  ...
  return (
    <div className="group flex items-start gap-4 rounded-2xl border border-[#22334A]/6 bg-white p-4 shadow-sm transition hover:border-[#2691C2]/20 hover:shadow-md">
      <span className="flex h-11 w-11 shrink-0 items-center justify-center overflow-hidden rounded-xl bg-[#F8FAFC] ring-1 ring-[#22334A]/6">
      ...
      <div className="min-w-0 flex-1">
        <div className="flex items-start justify-between gap-2">
          <p className="line-clamp-1 text-sm font-bold text-[#22334A]" title={file.original_name}>
            {file.original_name}
          </p>
        ...
        <p className="mt-0.5 line-clamp-1 text-xs font-semibold text-[#2691C2]/80">{file.category_label}</p>

        <div className="mt-2 flex flex-wrap items-center justify-between gap-2">
          <div className="flex flex-wrap items-center gap-2">
            <p className="text-[11px] font-medium text-[#22334A]/35">
            ...
            {file.processing_status === 'optimized' && file.optimized_size ? (
              ...
              <span className="font-latin text-[11px] font-medium text-[#22334A]/25">{file.file_size_humans}</span>
            )}
    ...
    <div className="fixed inset-0 z-[70] flex items-center justify-center bg-black/45 p-4 backdrop-blur-sm">
      <div className="w-full max-w-sm rounded-2xl bg-white p-6 shadow-2xl" dir="rtl">
        ...
        <p className="mb-5 text-xs font-medium text-slate-500">
          هل أنت متأكد من حذف <span className="font-bold text-[#22334A]">{file.original_name}</span>؟
        </p>
...
export default function AmbassadorApplicationFiles({
  ...
  return (
    <div className="rounded-2xl border border-[#22334A]/[0.06] bg-white p-5 shadow-sm" dir="rtl">
      <div className="mb-4 flex items-center justify-between border-b border-slate-100 pb-3">
        <h3 className="text-sm font-bold text-[#22334A]">المرفقات والملفات</h3>
