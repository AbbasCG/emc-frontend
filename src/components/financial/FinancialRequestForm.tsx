...
import type { FinancialRequest, FinancialRequestPriority, FinancialRequestType, MyFinancialContext } from '@/api/financialRequestsApi'
import {
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <select
                        value={type}
                        onChange={e => setType(e.target.value as FinancialRequestType)}
                        className={`${INPUT_BASE} appearance-none pr-10 border-slate-200`}
                      >
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      {PRIORITIES.map(p => (
                        <button
                          key={p.value}
                          type="button"
                          onClick={() => setPriority(p.value as FinancialRequestPriority)}
