...
const SPARKS = [
  ...
  // ── مكتبة العطاء وترك الأثر ──
  'العلم يزكو بالإنفاق — علّم غيرك ما تعلمته اليوم.',
  'جدّد نيتك: العمل نفسه، والأجر يتضاعف بالنية.',
  'أثرك الحقيقي ما يبقى بعد انصرافك من الاجتماع.',
  'من دلّ على خير فله مثل أجر فاعله.',
  'ساعة صادقة في خدمة متعلم خير من شهر بلا أثر.',
  'الأيادي التي تبني غيرها لا تُنسى.',
  'خيركم من تعلم العلم وعلمه.',
  'ازرع اليوم مهارة في زميل، تحصد غداً فريقاً كاملاً.',
  'العطاء لا ينقص الرصيد — يضاعفه في ميزان آخر.',
  'المتطوع القوي يصنع متطوعين أقوى.',
  'لا تحقرن من المعروف شيئاً — ولو مهمة صغيرة أتقنتها.',
  'التعليم صدقة جارية: كل من ينتفع بعلمك فأنت شريك في أجره.',
  'ابدأ بنية، واستمر بإتقان، واختم بأثر.',
] as const
