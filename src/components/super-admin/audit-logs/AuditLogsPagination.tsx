    ...
    >
      <div className="flex flex-wrap items-center gap-2.5 text-[12px] text-slate-500">
        ...
        <select
          ...
          className="h-9 rounded-xl border border-slate-200 bg-white px-3 text-[12px] font-bold text-[#0C2A4B] outline-none focus:border-[#0077B6]/50 focus:ring-2 focus:ring-[#0077B6]/12"
        >
      ...
      <div className="flex items-center gap-1.5">
        <button type="button" disabled={safePage <= 1} onClick={() => onPageChange(1)} className="flex h-9 w-9 items-center justify-center rounded-xl border border-slate-200 bg-white text-slate-400 shadow-sm transition hover:border-[#0077B6]/40 hover:text-[#0077B6] disabled:cursor-not-allowed disabled:opacity-30" aria-label="الأولى">
          <ChevronsRight className="h-4 w-4" />
        </button>
        <button type="button" disabled={safePage <= 1} onClick={() => onPageChange(safePage - 1)} className="flex h-9 w-9 items-center justify-center rounded-xl border border-slate-200 bg-white text-slate-400 shadow-sm transition hover:border-[#0077B6]/40 hover:text-[#0077B6] disabled:cursor-not-allowed disabled:opacity-30" aria-label="السابقة">
