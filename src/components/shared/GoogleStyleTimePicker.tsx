  ...
  return (
    <div className={cn('block text-right', className)} dir="rtl">
      {label && (
        <label
          htmlFor={fieldId}
          className="mb-1.5 block text-[12px] font-black text-[#22334A]/70"
        >
          {label}
          {required && <span className="text-[#EC943C]"> *</span>}
        </label>
      )}
      ...
      <button
        ...
        className={cn(
          ...
          error
            ...
            : 'border-[#22334A]/12 hover:border-[#2691C2]/40 focus:border-[#2691C2]/60',
          'bg-white focus:outline-none focus:ring-4 focus:ring-[#2691C2]/10',
      ...
      >
        ...
        <span className="min-w-0 flex-1 font-semibold tabular-nums" style={{ fontSize: 13 }}>
          {displayValue
            ? <span className="text-[#22334A]">{displayValue}</span>
      ...
      >
        <div
          ...
          className="overflow-hidden rounded-2xl border border-[#22334A]/8 bg-white shadow-[0_8px_30px_-6px_rgba(34,51,74,0.22),0_2px_8px_-2px_rgba(34,51,74,0.12)]"
          dir="rtl"
        >
          {/* manual typing row */}
          <div className="border-b border-slate-100 px-3 py-2.5">
            <div className="flex items-center gap-2 rounded-xl border border-slate-200 bg-slate-50 px-2.5 py-1.5 focus-within:border-[#2691C2]/50 focus-within:ring-2 focus-within:ring-[#2691C2]/10">
              <Clock className="h-3.5 w-3.5 shrink-0 text-[#2691C2]/60" aria-hidden />
              <input
                ref={inputRef}
                type="text"
                dir="ltr"
                ...
                className="min-w-0 flex-1 bg-transparent font-mono text-[13px] font-semibold text-[#22334A] outline-none placeholder:text-slate-400"
              />
            </div>
          </div>
