      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-12 px-4 py-16 sm:px-6 lg:grid-cols-2 lg:gap-14 lg:px-8 lg:py-20">
        <div className="order-2 text-right lg:order-1">
          ...
          >
            ...
            <motion.h1
              variants={fadeUp}
              className="font-display text-4xl font-black leading-[1.12] tracking-tight text-deepBlue sm:text-5xl lg:text-[3.15rem]"
            >
              {title}
            </motion.h1>
            <motion.p
              ...
              <motion.div variants={fadeUp} className="mt-8 flex flex-wrap gap-4">
                {ctaText && ctaLink && (
                  <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                    <Link
                      to={ctaLink}
                      className="group relative inline-flex items-center gap-2 overflow-hidden rounded-2xl bg-accent-gradient px-7 py-4 text-base font-extrabold text-white shadow-emc-glow-accent transition-all duration-300 ease-emc-out hover:shadow-emc-md"
                    >
