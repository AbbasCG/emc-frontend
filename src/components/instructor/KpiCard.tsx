...
function KpiCardInner({
  ...
  label,
  value,
  tone = 'text-[#0077B6] bg-[#0077B6]/[0.08]',
  badge,
  index = 0,
  loading,
}: Props) {
  ...
  return (
    <motion.div
      ...
      whileHover={{ y: -2 }}
      className="group relative overflow-hidden rounded-[16px] border border-[#0C2A4B]/[0.06] bg-white p-4 shadow-[0_1px_3px_rgba(15,23,42,0.04)] transition-shadow hover:shadow-[0_8px_24px_-12px_rgba(0,119,182,0.18)]"
    >
      ...
      <div className="mt-3">
        {loading ? (
          ...
          <p className="font-mono text-[22px] font-bold leading-none tabular-nums text-[#0C2A4B]">
