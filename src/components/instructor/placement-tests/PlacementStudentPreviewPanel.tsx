...
export function PlacementStudentPreviewPanel({ row, onViewDetails }: Props) {
  if (!row) {
    return (
      <aside className="sticky top-4 rounded-[16px] border border-dashed border-[#22334A]/10 bg-[#F8FAFC]/80 p-8 text-center">
  ...
  return (
    <motion.aside
      ...
      className="sticky top-4 rounded-[16px] border border-[#22334A]/[0.06] bg-white shadow-[0_1px_3px_rgba(15,23,42,0.04)]"
    >
      <div className="border-b border-slate-100 bg-gradient-to-l from-[#22334A]/5 to-transparent p-4">
        <div className="flex flex-col items-center text-center">
          {row.avatar_url ? (
            <img src={row.avatar_url} alt="" className="h-16 w-16 rounded-2xl object-cover ring-4 ring-white shadow-md" />
          ) : (
            <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-[#22334A]/8 text-xl font-black text-deepBlue">
      ...
      <div className="space-y-3 p-4">
        ...
        <div className="space-y-1.5 pt-1">
          <button
            ...
            className="flex w-full items-center justify-center gap-2 rounded-xl bg-[#22334A] px-3 py-2.5 text-[11px] font-black text-white transition hover:brightness-110"
          >
          ...
          <Link
            ...
            className="flex w-full items-center justify-center gap-2 rounded-xl border border-[#2691C2]/25 bg-sky-50/50 px-3 py-2.5 text-[11px] font-black text-[#2691C2] transition hover:bg-sky-50"
          >
