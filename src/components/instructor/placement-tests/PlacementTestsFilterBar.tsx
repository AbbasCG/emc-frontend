...
export function PlacementTestsFilterBar(props: Props) {
  ...
  return (
    <div className="rounded-[16px] border border-[#22334A]/[0.06] bg-white/80 p-3 shadow-[0_4px_24px_-12px_rgba(15,23,42,0.12)] backdrop-blur-md sm:p-4">
      ...
      <div className="flex flex-col gap-2 lg:flex-row lg:flex-wrap lg:items-center">
        <div className="relative min-w-0 flex-1 lg:min-w-[200px]">
          ...
          <input
            ...
            dir="rtl"
            className="h-10 w-full rounded-xl border border-[#22334A]/10 bg-[#F8FAFC]/90 pr-10 pl-3 text-[12px] font-semibold text-deepBlue outline-none focus:border-[#2691C2] focus:bg-white focus:ring-2 focus:ring-[#2691C2]/15"
          />
        </div>
        ...
        <input
          ...
          dir="ltr"
          className="h-10 rounded-xl border border-[#22334A]/10 bg-white px-3 text-[11px] font-semibold text-deepBlue outline-none focus:border-[#2691C2] focus:ring-2 focus:ring-[#2691C2]/15"
          title="تاريخ الإكمال"
        />
  ...
  return (
    <div className="relative min-w-[130px]">
      <select
        ...
        dir="rtl"
        title={label}
        className="h-10 w-full appearance-none rounded-xl border border-[#22334A]/10 bg-white py-0 pl-8 pr-3 text-[11px] font-bold text-deepBlue/80 outline-none focus:border-[#2691C2] focus:ring-2 focus:ring-[#2691C2]/15"
      >
        {children}
      </select>
