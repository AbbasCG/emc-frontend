    ...
    <AnimatePresence>
      {group && (
        ...
        >
          ...
          >
            <div className="border-b border-slate-100 bg-gradient-to-l from-[#0C2A4B] to-[#0077B6] px-6 py-5 text-white">
            ...
            <div className="flex-1 overflow-y-auto px-6 py-5">
              ...
              {group.meeting_link && (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="mt-4 inline-flex items-center gap-2 rounded-xl bg-[#0077B6]/10 px-3 py-2 text-[11px] font-black text-[#0077B6]"
                >
                    ...
                    {students.map((s) => {
                      ...
                      return (
                        <div key={s.student_id} className="flex items-center gap-3 rounded-2xl border border-slate-100 bg-white p-3 shadow-sm">
                          <div className="flex h-10 w-10 shrink-0 items-center justify-center overflow-hidden rounded-xl bg-gradient-to-bl from-[#0C2A4B] to-[#0077B6] text-[11px] font-black text-white">
                            {s.avatar_url ?
            ...
            <div className="border-t border-slate-100 bg-slate-50/80 px-6 py-4">
              <div className="grid grid-cols-3 gap-2">
                <Link
                  ...
                  className="flex flex-col items-center gap-1 rounded-2xl border border-slate-200 bg-white px-2 py-3 text-[10px] font-black text-deepBlue transition hover:border-[#0077B6]/30"
                >
                ...
                <Link
                  ...
                  className="flex flex-col items-center gap-1 rounded-2xl border border-slate-200 bg-white px-2 py-3 text-[10px] font-black text-deepBlue transition hover:border-[#0077B6]/30"
                >
                  <CalendarCheck className="h-4 w-4 text-[#0077B6]" />
                  الجلسات
                </Link>
              </div>
            </div>
