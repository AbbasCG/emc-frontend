...
export function PlacementStudentList({ students, selectedId, onSelect, search, onSearchChange }: Props) {
  ...
  return (
    <div className="flex h-full flex-col rounded-[16px] border border-[#22334A]/[0.06] bg-white shadow-[0_1px_3px_rgba(15,23,42,0.04)]">
      <div className="border-b border-slate-100 p-3">
        ...
        <div className="relative">
          ...
          <input
            ...
            dir="rtl"
            className="h-10 w-full rounded-xl border border-slate-200 bg-slate-50/80 pr-10 pl-3 text-[12px] font-semibold text-deepBlue outline-none focus:border-[#2691C2] focus:bg-white focus:ring-2 focus:ring-sky-100"
          />
        </div>
      </div>
                ...
                <li key={row.attempt_id || row.student_id}>
                  <motion.button
                    ...
                    className={`w-full rounded-xl border px-3 py-2.5 text-right transition ${
                      active
                        ? 'border-[#2691C2]/40 bg-sky-50/80 shadow-[0_4px_16px_-8px_rgba(38,145,194,0.35)]'
                  ...
                  >
                    <div className="flex items-center gap-2.5">
                      {row.avatar_url ? (
                        ...
                        <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-[#22334A]/8 text-[12px] font-black text-deepBlue">
                      ...
                      <div className="shrink-0 text-left">
                        <p className="font-mono text-[11px] font-black tabular-nums text-[#2691C2]">
                          {pct != null ? `${pct}%` : '—'}
                        </p>
                        {badge && (
