    ...
    <div className="space-y-4 print:space-y-2">
      ...
      <div className="flex flex-col gap-4 xl:flex-row xl:items-start">
        <div className="min-w-0 flex-1 space-y-4">
          {/* Tabs */}
          <div className="print:hidden flex flex-wrap gap-1 rounded-2xl border border-[#22334A]/[0.06] bg-white p-1.5 shadow-sm">
          ...
          {/* Tab panels */}
          <div className="rounded-[16px] border border-[#22334A]/[0.06] bg-white shadow-sm">
            {activeTab === 'written' && (
