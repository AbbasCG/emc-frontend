  ...
  return (
    <div className="shrink-0 border-b border-slate-100 bg-gradient-to-l from-sky-50/90 via-white to-white px-4 py-4 sm:px-6">
      <div className="mb-3 flex items-center gap-2">
        <div className="grid h-8 w-8 place-items-center rounded-xl bg-[#2691C2]/10 text-[#2691C2]">
      ...
      <div className="grid gap-2 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-8">
        <Metric label="الدرجة" value={`${row.written_score ?? '—'}/${row.total_questions ?? '—'}`} accent="#2691C2" large />
        <Metric label="النسبة" value={pct != null ? `${pct}%` : '—'} accent="#EC943C" />
...
function Metric({
  ...
  return (
    <div className="rounded-xl border border-[#22334A]/[0.06] bg-white/80 px-3 py-2.5 shadow-sm backdrop-blur-sm">
