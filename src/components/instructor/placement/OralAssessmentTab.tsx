        ...
        <>
          ...
          <div className="rounded-2xl border border-[#0C2A4B]/[0.06] bg-white p-4 shadow-sm">
            <div className="mb-3 flex items-center justify-between">
              ...
              {totalOralScore != null && (
                <span className="font-mono text-[12px] font-black tabular-nums text-[#0077B6]">
              ...
              {ORAL_SCORES.map(({ key, label, max }) => (
                <label key={key} className="block">
                  ...
                  <input
                    ...
                    placeholder="—"
                    className="mt-1.5 h-10 w-full rounded-xl border border-slate-200 bg-white px-3 text-[13px] font-semibold text-deepBlue outline-none transition focus:border-[#0077B6] focus:ring-2 focus:ring-sky-100"
                  />
                </label>
              ))}
            </div>
 ...
 {b ? `${b.cefr} ${b.arabic}`: lvl.label}
          ...
          <div className="flex flex-wrap gap-3">
            <button
              ...
              className="inline-flex flex-1 items-center justify-center gap-2 rounded-2xl bg-[#0077B6] px-5 py-3 text-[13px] font-black text-white transition hover:brightness-105 disabled:opacity-50 sm:flex-none sm:min-w-[200px]"
            >
