...
export function PlacementAssessmentHeader({ row }: Props) {
  ...
  return (
    <div className="relative overflow-hidden rounded-[20px] border border-[#0C2A4B]/[0.06] bg-gradient-to-l from-[#0C2A4B] to-[#1a2d44] p-5 text-white shadow-[0_16px_48px_-20px_rgba(15,23,42,0.45)] sm:p-6">
      <div className="pointer-events-none absolute -left-8 top-0 h-32 w-32 rounded-full bg-[#F28C00]/20 blur-[50px]" />
      <div className="pointer-events-none absolute -bottom-6 right-0 h-24 w-24 rounded-full bg-[#0077B6]/25 blur-[40px]" />
...
function ScorePill({
  ...
  return (
    <div className={`rounded-2xl border px-3 py-2.5 backdrop-blur-sm ${highlight ? 'border-[#F28C00]/40 bg-[#F28C00]/15' : 'border-white/10 bg-white/10'}`}>
