              ...
              >
                ...
                <td className="px-4 py-3">
                  {registrar ? (
                    <div className="flex items-center gap-2">
                      <span className="grid h-6 w-6 shrink-0 place-items-center rounded-lg bg-[#0C2A4B]/10 text-[9px] font-black text-[#0C2A4B]">
                ...
                <td className="px-4 py-3">
                  <button
                    ...
                    className="rounded-xl border border-[#E2E8F0] p-2 text-[#64748B] hover:bg-white hover:text-[#0077B6]"
                  >
...
export function MobileManualPaymentCard({
  ...
  return (
    <article
      className="rounded-[16px] border border-[#E2E8F0] bg-white p-4 shadow-sm transition hover:border-[#0077B6]/30"
      dir="rtl"
    >
