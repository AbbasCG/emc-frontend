  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        exit={{ opacity: 0 }}
      >
        <div className="absolute inset-0 bg-[#22334A]/30 backdrop-blur-[1px]" onClick={onCancel} aria-hidden />
        <motion.div
          role="dialog"
          aria-modal="true"
        ...
        >
          ...
          <label className="mt-4 block text-right">
            ...
            <textarea
              ...
              rows={2}
              className="mt-1.5 w-full rounded-2xl border border-[#E2E8F0] px-3 py-2 text-[12px] font-semibold outline-none focus:border-[#2691C2]/50 focus:ring-2 focus:ring-[#2691C2]/15"
            />
          </label>
  ...
  return (
    <AnimatePresence>
      <motion.div className="fixed inset-0 z-[400] flex items-center justify-center p-4" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
        <div className="absolute inset-0 bg-[#22334A]/30" onClick={onCancel} aria-hidden />
        <motion.div
          role="dialog"
          aria-modal="true"
