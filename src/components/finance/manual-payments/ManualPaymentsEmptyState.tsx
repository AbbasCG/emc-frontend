    ...
    return (
      <div className="flex flex-col items-center px-6 py-16 text-center" dir="rtl">
        ...
        <button
          type="button"
          onClick={onReset}
          className="mt-5 inline-flex items-center gap-2 rounded-2xl border border-[#E2E8F0] bg-white px-5 py-2.5 text-[12px] font-black text-[#0C2A4B]"
        >
  ...
  return (
    ...
    >
      <motion.div
        ...
        className="grid h-14 w-14 place-items-center rounded-2xl bg-[#0077B6]/10 text-[#0077B6]"
      >
      ...
      {onCreate && (
        <button
          type="button"
          onClick={onCreate}
          className="mt-5 inline-flex items-center gap-2 rounded-2xl bg-[#F28C00] px-5 py-2.5 text-[12px] font-black text-white"
        >
