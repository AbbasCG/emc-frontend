...
export default function ManualPaymentDetailDrawer({
  ...
  const refreshPayment = useCallback(async () => {
    ...
    const fresh = await fetchManualPayment(payment.id)
    setPayment(fresh)
    onUpdated()
  }, [payment?.id, onUpdated])
      ...
      <motion.div className="fixed inset-0" style={{ zIndex: 320 }} initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
        ...
        >
          <div className="flex items-center justify-between border-b border-[#E2E8F0] px-5 py-4">
            <div>
              <p className="text-[10px] font-black uppercase tracking-[0.16em] text-[#2691C2]">تفاصيل الدفعة</p>
            ...
            {payment.student && (
              <section className="mt-5 rounded-2xl border border-[#E2E8F0] bg-[#F6F8FB] p-4">
                ...
                <div className="mt-2 flex items-start gap-3">
                  <div className="grid h-10 w-10 place-items-center rounded-xl bg-[#2691C2]/10 text-[#2691C2]">
              ...
              <section className="mt-5 rounded-2xl border border-[#E2E8F0] p-4">
                ...
                <div className="mt-2 flex items-center justify-between gap-3">
                  <div className="flex items-center gap-2 text-[12px] font-bold text-[#0F172A]">
                    <FileText className="h-4 w-4 text-[#2691C2]" aria-hidden />
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 rounded-xl border border-[#E2E8F0] px-3 py-1.5 text-[11px] font-black text-[#22334A] disabled:opacity-50"
                  >
