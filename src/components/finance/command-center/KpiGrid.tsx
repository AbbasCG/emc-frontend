      ...
      {cards.map((kpi) => {
        ...
        return (
          <motion.article
            ...
            className={`group relative overflow-hidden rounded-2xl border border-deepBlue/[0.05] bg-white p-4 shadow-[0_1px_2px_rgba(34,51,74,0.04)] ring-1 ring-transparent transition-shadow hover:shadow-[0_8px_28px_-12px_rgba(34,51,74,0.15)] ${style.ring}`}
          >
