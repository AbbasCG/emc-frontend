...
export default function FinanceHeader({
  ...
  return (
    <motion.header
      ...
      className="relative overflow-hidden rounded-2xl border border-deepBlue/[0.08] bg-gradient-to-l from-deepBlue via-[#1a3a55] to-brand-600 px-5 py-5 text-white shadow-[0_12px_40px_-16px_rgba(34,51,74,0.45)] sm:px-6 sm:py-6"
    >
      <div
        aria-hidden
