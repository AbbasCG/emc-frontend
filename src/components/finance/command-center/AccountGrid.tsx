...
function AccountCard({
  ...
  return (
    <motion.article
      ...
      className="group relative overflow-hidden rounded-2xl border border-deepBlue/[0.06] bg-white p-4 shadow-sm transition-shadow hover:shadow-[0_12px_32px_-14px_rgba(34,51,74,0.18)]"
    >
