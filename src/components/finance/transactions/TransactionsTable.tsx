              ...
              >
                ...
                <td className="px-4 py-3">
                  <button
                    ...
                    className="inline-flex items-center gap-1 rounded-xl border border-[#E2E8F0] bg-white px-2.5 py-1.5 text-[10px] font-black text-[#2691C2] transition hover:bg-[#2691C2]/5"
                  >
