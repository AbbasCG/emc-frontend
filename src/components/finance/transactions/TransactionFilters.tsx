...
export default function TransactionFilters({
  ...
  const fields = (
    <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
      ...
      <label className="text-right">
        <span className="mb-1.5 block text-[11px] font-black text-[#22334A]">نوع المعاملة</span>
        <select
          value={filters.type}
  ...
  return (
    ...
    >
      <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
        <div className="flex items-center gap-2 text-[#22334A]">
          <Filter className="h-4 w-4 text-[#2691C2]" aria-hidden />
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <button
            type="button"
            onClick={onReset}
            className="inline-flex items-center gap-1.5 rounded-xl border border-[#E2E8F0] bg-[#F6F8FB] px-3 py-1.5 text-[11px] font-black text-[#22334A] transition hover:border-[#2691C2]/30"
          >
