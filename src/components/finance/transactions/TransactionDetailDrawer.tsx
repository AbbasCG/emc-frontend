      ...
      >
        ...
        >
          <div className="flex items-center justify-between border-b border-[#E2E8F0] px-5 py-4">
            <div>
              <p className="text-[10px] font-black uppercase tracking-[0.16em] text-[#0077B6]">تفاصيل المعاملة</p>
          ...
          <div className="border-t border-[#E2E8F0] p-4">
            <div className="flex flex-wrap gap-2">
              <button
                ...
                className="inline-flex flex-1 items-center justify-center gap-2 rounded-2xl border border-[#E2E8F0] px-4 py-2.5 text-[12px] font-black text-[#0C2A4B]"
              >
              ...
              {tx.payment_id != null && (
                <Link
                  to={`${base}/payments`}
                  className="inline-flex flex-1 items-center justify-center gap-2 rounded-2xl bg-[#0077B6] px-4 py-2.5 text-[12px] font-black text-white"
                >
