    ...
    <div className="flex flex-col items-center px-6 py-16 text-center" dir="rtl">
      ...
      {hasFilters && (
        <button
          type="button"
          onClick={onReset}
          className="mt-5 inline-flex items-center gap-2 rounded-2xl border border-[#E2E8F0] bg-white px-5 py-2.5 text-[12px] font-black text-[#0C2A4B] transition hover:border-[#0077B6]/40"
        >
