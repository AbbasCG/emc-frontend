    ...
    <header dir="rtl">
      ...
      >
        <nav aria-label="مسار التنقل" className="mb-3 flex flex-wrap items-center gap-2 text-[12px] font-bold text-[#64748B]">
          ...
          <span className="font-black text-[#22334A]">المعاملات المالية</span>
        </nav>
        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          ...
          <div className="flex flex-wrap items-center justify-end gap-2.5">
            <button
              ...
              className="inline-flex h-11 items-center gap-2 rounded-2xl border border-[#E2E8F0] bg-white px-4 text-[12px] font-black text-[#22334A] transition hover:border-[#2691C2]/35 hover:bg-[#F6F8FB] disabled:opacity-45"
            >
              <Download className="h-4 w-4 text-[#2691C2]" aria-hidden />
              تصدير
            </button>
            <button
              type="button"
              ...
              className="inline-flex h-11 items-center gap-2 rounded-2xl bg-[#22334A] px-4 text-[12px] font-black text-white transition hover:bg-[#1a2940] disabled:opacity-60"
            >
