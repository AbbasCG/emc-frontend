  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-ink-900 via-deepBlue to-[#1a2a3f] pt-28 pb-14 text-right" dir="rtl">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6">
        ...
        : null}
        <p className="text-[11px] font-black uppercase tracking-[0.2em] text-[#F28C00]">{eyebrow}</p>
        ...
        {onSearchChange ?
          <div className="relative mt-8 max-w-xl">
            ...
            <input
              ...
              className="w-full rounded-2xl border border-white/10 bg-white/10 py-3.5 pe-4 ps-12 text-sm font-semibold text-white placeholder:text-white/40 backdrop-blur-sm focus:border-[#0077B6]/50 focus:outline-none focus:ring-2 focus:ring-[#0077B6]/30"
              dir="rtl"
            />
          </div>
        : null}
