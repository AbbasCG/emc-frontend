  ...
  return (
    <div className="rounded-3xl border border-slate-100 bg-white p-4 shadow-sm sm:p-6" dir="rtl">
      <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
        <h2 className="text-lg font-black text-[#0C2A4B]">{formatWeekTitle(anchor)}</h2>
            ...
            return (
              <div
                ...
                className={[
                  ...
                  day.isToday ? 'ring-2 ring-[#0077B6]/35' : '',
                ].join(' ')}
              >
                <p className="mb-2 text-[11px] font-black text-[#0C2A4B] sm:text-xs">{day.label}</p>
