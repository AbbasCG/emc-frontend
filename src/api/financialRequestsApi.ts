...
export async function uploadAttachment(id: number, file: File): Promise<FinancialRequestAttachment> {
  ...
  fd.append('file', file)
  const res = await apiClient.post<any>(`${BASE}/${id}/attachments`, fd, {
